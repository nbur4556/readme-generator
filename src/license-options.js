...
const allLicenses = [
    new License('Academic Free v3.0',
        '![License](https://img.shields.io/badge/License-Academic%203.0-blue.svg)',
    ...
    new License('Educational Community v2.0',
        '![License](https://img.shields.io/badge/License-Educational%202.0-blue.svg)',
    ...
    new License('European Union Public 1.1',
        '![License](https://img.shields.io/badge/License-EU%201.1-blue.svg)',
    ...
    new License('LaTeX Project Public v1.3c',
        '![License](https://img.shields.io/badge/License-LaTeX%20v1.3c-blue.svg)',
        'https://spdx.org/licenses/LPPL-1.3c.html'),
    new License('Microsoft Public',
        '![License](https://img.shields.io/badge/License-Microsoft%201-blue.svg)',
    ...
    new License('Open Software 3.0',
        '![License](https://img.shields.io/badge/License-Open%203.0-blue.svg)',
        'https://opensource.org/licenses/OSL-3.0'),
    new License('PostgreSQL',
        '![License](https://img.shields.io/badge/License-PostgreSQL%201-blue.svg)',
    ...
    new License('University of Illinois/NCSA Open Source',
        '![License](https://img.shields.io/badge/License-UofI%20-blue.svg)',
